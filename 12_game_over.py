...
def display_game_over():
    ...
    rect_gmae_over = txt_game_over.get_rect(center=(screen_width // 2, screen_height // 2))
    screen.blit(txt_game_over, rect_gmae_over)
...
background = pygame.image.load(os.path.join(curr_path, "background.png"))
# 벽 이미지 불러오기
wall = pygame.image.load(os.path.join(curr_path, "wall.png"))

# 버블 이미지 불러오기
bubble_images = [
    pygame.image.load(os.path.join(curr_path, "red.png")).convert_alpha(),
    pygame.image.load(os.path.join(curr_path, "yellow.png")).convert_alpha(),
    pygame.image.load(os.path.join(curr_path, "blue.png")).convert_alpha(),
    pygame.image.load(os.path.join(curr_path, "green.png")).convert_alpha(),
    pygame.image.load(os.path.join(curr_path, "purple.png")).convert_alpha(),
    pygame.image.load(os.path.join(curr_path, "black.png")).convert_alpha()
]

# 발사대 이미지 불러오기
pointer_image = pygame.image.load(os.path.join(curr_path, "pointer.png"))
